...
class Template(DnacBase):
    ...
    def input_data_validation(self, config):
        """
        Additional validation to check if the provided input configuration template is correct
        and as per the UI Cisco Catalyst Center.

        Parameters:
            self (object): An instance of a class for interacting with Cisco Catalyst Center.
            config (dict): Dictionary containing the template configuration details.
    ...
    def delete_project(self, project_name):
        """
        Delete a project from Cisco DNA Center by project name.

        Parameters:
            project_name (str) - The name of the project to delete.

        Returns:
            self - The current object with project deletion information.
        """
    ...
    def apply_project_config(self, config):
        """
        Create/Update the project for the template
